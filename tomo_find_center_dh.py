...
#    data = filters.gaussian_laplace(data,5)
    # raw_data_top_dir = "/home/VTLinlab/Documents/Zhengrui/TXM/In-situ heating/Rod2_pristine"
...
# use bash batch code to run a set of scan_idx
    raw_data_top_dir = "/run/media/VTLinlab/Lin_Lab_5/DH/BNL_NOV2020/DH004BAMF5"
    scan_idx = [74063]
    
# in bash shell, batch finding center
# for i in {74001..74063}; do python '/run/media/VTLinlab/Lin_Lab_5/DH/BNL_NOV2020/tomo_recon_find_center_DH_202011.py' $i; done
...
#center_list = [1376.5, 1336, 1344]                  # If you find center values for the list of data sets defined in scan_idx above, you put
    ...
    recon_top_dir = None
    #recon_top_dir = home/VTLinlab/Documents/Zhengrui/TXM/In-situ heating/Rod2_pristine
    ...
    if manualCenter == True:
        ...
        data_center_path = os.path.join(raw_data_top_dir,'data_center_'+str(scan_idx[0]))
    #print(data_center_path)
...
### define filter combination
    ...
    use_normalize_bg =      {'use':'yes',
                             'order':4}

    use_retrieve_phase =    {'use':'no',
                             'order':3}

    use_denoise_filter =    {'use':'yes',
                             'order':3}
